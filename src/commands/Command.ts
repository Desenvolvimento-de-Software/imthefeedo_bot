...
export default abstract class Command {
     ...
     * @param message
     */
    protected async adminOnlyAction(): Promise<any> {
        return this.context?.getMessage()?.reply("Você precisa ter privilégios de administração para executar esta operação.");
    }
}
